...
const response = await fetch('https://shikabot-mu.vercel.app/api/line/diagnose?clinic_id=11111111-1111-1111-1111-111111111111');
...
const linkagesResponse = await fetch('https://shikabot-mu.vercel.app/api/line/get-linkages?clinic_id=11111111-1111-1111-1111-111111111111');
