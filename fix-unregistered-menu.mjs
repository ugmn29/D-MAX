...
// LINE設定を取得してChannel Access Tokenを取得
...
if (lineError || !lineSettings) {
  ...
  console.error('sync-line-settings-to-db.mjsを実行してください');
  process.exit(1);
}
...
if (!CHANNEL_ACCESS_TOKEN) {
  console.error('❌ Channel Access Tokenが設定されていません');
  process.exit(1);
}

console.log('✅ Channel Access Token を取得しました\n');
